...
gr4 = pd.read_csv("./saida_gr4j.csv",index_col = 0,parse_dates = True)
...
lisflood = pd.read_csv("/discolocal/felipe/git_pm/lisf_pm/tabelas/resultados/validando/calibrar_tudo_03.csv",index_col = 0,parse_dates = True)
...
#%%
ln = np.log(df[["Q_fore","Porto_Amazonas","ls_sim"]])
